...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer py-10 px-12 lg:px-28 bg-slate-700  text-white">
                <div>
            ...
            <footer className="footer px-12 lg:px-28 py-4 border-t bg-slate-700 text-white border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Summer zone site. <br />Copyright C {year} - All right reserve by Summer zone</p>
                </div>

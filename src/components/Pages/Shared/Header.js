        ...
        <div className='sticky top-0 ' >
            <div className="navbar  bg-base-100">
                ...
                <div className="navbar-end lg:mr-24">
                    {
                        user ?
                            <button className='hidden lg:block md:block px-2 mr-4 rounded-full font-serif text-blue-500 border-blue-400 border-2' ><span className='flex justify-center items-center'>
                                <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-1">
